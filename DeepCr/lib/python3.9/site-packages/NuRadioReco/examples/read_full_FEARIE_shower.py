...
parser.add_argument('inputfilename', type=str, nargs='*',
                    default=['/Users/chiche/Desktop/REGevents/HDF5files/Rectangle_Proton_0.1_10_0_1_0.hdf5'],
                    help='path to NuRadioMC simulation result')

parser.add_argument('--detectordescription', type=str, nargs='?',
                    default='/Users/chiche/Desktop/DeepCrSearch/NuRadioMC/NuRadioReco/detector/RNO_G/RNO_single_station.json',
